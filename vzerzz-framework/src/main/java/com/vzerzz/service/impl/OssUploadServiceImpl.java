...
import com.vzerzz.utils.PathUtils;
...
public class OssUploadServiceImpl implements OssUploadService {
    ...
    public ResponseResult uploadImg(MultipartFile img) {
        ...
        if(!originalFilename.endsWith(".png") && !originalFilename.endsWith(".jpg")){
            //AppHttpCodeEnum是我们在vzerzz-framework写的枚举类，FILE_TYPE_ERROR代表文件类型错误的提示
            throw new SystemException(AppHttpCodeEnum.FILE_TYPE_ERROR);
        }

        //如果满足判断条件，则上传文件到七牛云OSS，并得到一个图片外链访问地址。PathUtil是我们在vzerzz-framework工程写的工具类
    ...
    private String uploadOss(MultipartFile imgFile, String filePath){
        ...
        try {
            ...
            try {
                ...
                return "http://s0srvv6dm.hn-bkt.clouddn.com/"+key;
