...
import com.vzerzz.utils.JwtUtil;
...
public class SystemLoginServiceImpl implements SystemLoginService {
    ...
    @Autowired
    //RedisCache是我们在vzerzz-framework工程的config目录写的类
    ...
    public ResponseResult login(User user) {
        ...
        //在下一行之前，封装的数据会先走UserDetailsServiceImpl实现类，这个实现类在我们的vzerzz-framework工程的service/impl目录里面
    ...
    public ResponseResult logout() {
        //获取当前登录的用户id。SecurityUtils是我们在vzerzz-framework工程写的类
