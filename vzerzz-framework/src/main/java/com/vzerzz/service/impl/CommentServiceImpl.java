...
import com.vzerzz.mapper.CommentMapper;
...
import com.vzerzz.vo.CommentVo;
...
import static com.vzerzz.constants.SystemCanstants.COMMENT_NORMAL;
...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService{
    ...
    public ResponseResult addComment(Comment comment) {
        ...
        //为了解决这个问题，我们在vzerzz-framework工程新增了MyMetaObjectHandler类、修改了Comment类。详细可自己定位去看一下代码

        // 文章限制不能评论
        if(!articleService.getById(comment.getArticleId()).getIsComment().equals(COMMENT_NORMAL)){
            throw  new SystemException(AppHttpCodeEnum.NO_COMMENT);
        }
    ...
    private List<CommentVo> xxToCommentList(List<Comment> list){
        ...
        for (CommentVo commentVo : commentVos) {
            ...
            if(!Objects.isNull(userService.getById(commentVo.getCreateBy()))){
